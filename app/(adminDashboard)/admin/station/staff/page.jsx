...
const Staff = () => {
  ...
  const [pageSize, setPageSize] = useState(9); // Changed pageSize to 4
  ...
  const handleSearch = (columnName, value) => {
    setSearchFields({ ...searchFields, [columnName]: value });
  };
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="mb-4 grid grid-cols-3">
        ...
        <Button color="warning" className="shadow-md w-28"><Search size={20} className='pr-1'/>Search</Button>
      </div>
